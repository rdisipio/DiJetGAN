...
_h['jj_phi'] = TH1F(
    "jj_phi", ";t#bar{t} system #phi;Events / Bin Width", 32, -3.1415, 3.1415)
_h['jj_E'] = TH1F(
    "jj_E",  ";t#bar{t} system E [GeV];Events / Bin Width", 15, 0., 3000)
_h['jj_m'] = TH1F(
    "jj_m",  ";t#bar{t} system m [TeV];Events / Bin Width", 30, 0.5, 3.5)
_h['jj_dPhi'] = TH1F(
...
_h['jj_m_tail'] = TH1F(
    "jj_m_tail",  ";t#bar{t} system m [TeV];Events / Bin Width", 100, 0., 10.)
...
_h['ljet1_m_vs_pt'] = TH2F(
    "ljet1_m_vs_pt",  ";Leading large-R jet p_{T} [GeV];Leading large-R jet m [GeV]", 20, 200., 800., 30, 0., 300.)
...
_h['ljet2_m_vs_pt'] = TH2F(
    "ljet2_m_vs_pt",  ";2nd leading large-R jet p_{T} [GeV];2nd leading large-R jet m [GeV]", 20, 200., 800, 30, 0., 300.)
_h['ljet2_m_vs_eta'] = TH2F(
    "ljet2_m_vs_eta", ";2nd leading large-R jet #eta;2nd leading large-R jet m [GeV]", 25, -2.5, 2.5, 30, 0., 300.)
...
_h['ljet2_m_vs_ljet1_m'] = TH2F(
    "ljet2_m_vs_ljet1_m",   ";Leading large-R jet m [GeV];2nd leading large-R jet m [GeV]", 30, 0., 300., 30, 0., 300.)
...
_h['jj_dR_vs_jj_m'] = TH2F(
    "jj_dR_vs_jj_m", ";t#bar{t} system mass [GeV];t#bar{t} system #Delta R",  20, 0., 4., 15, 2., 5)
_h['jj_m_vs_jj_pt'] = TH2F(
    "jj_m_vs_jj_pt", ";t#bar{t} system p_{T} [GeV];t#bar{t} system mass [GeV]", 20, 0., 800, 20, 0., 4.)
_h['ljet1_pt_vs_jj_m'] = TH2F(
    "ljet1_pt_vs_jj_m", ";t#bar{t} system m [GeV];Leading large-R jet p_{T} [GeV];", 20, 0., 4., 20,   200., 800)
_h['ljet2_pt_vs_jj_m'] = TH2F(
    "ljet2_pt_vs_jj_m", ";t#bar{t} system m [GeV];2nd leading large-R jet p_{T} [GeV];", 20, 0., 4., 20,   200., 800)
