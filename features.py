header = [
  "runNumber", "eventNumber", "weight", "mu",
  ...
  "jj_px", "jj_py", "jj_pz", "jj_pt", "jj_eta", "jj_phi", "jj_E", "jj_M", "jj_dPhi", "jj_dEta", "jj_dR",
]
...
features_PtEtaPhiE = [
  "ljet1_pt", "ljet1_eta", "ljet1_phi", "ljet1_E",
  "ljet2_pt", "ljet2_eta", "ljet2_phi", "ljet2_E",
]
