...
_h = {}
_h['ljet1_px'] = TH1F( "ljet1_px", ";Leading large-R jet p_{x} [GeV];Events / Bin Width", 50, -500, 500 )
_h['ljet1_py'] = TH1F( "ljet1_py", ";Leading large-R jet p_{y} [GeV];Events / Bin Width", 50, -500, 500 )
_h['ljet1_pz'] = TH1F( "ljet1_pz", ";Leading large-R jet p_{z} [GeV];Events / Bin Width", 60, -1500, 1500 )
_h['ljet1_pt'] = TH1F( "ljet1_pt", ";Leading large-R jet p_{T} [GeV];Events / Bin Width", 40,  200.,  800 )
_h['ljet1_eta'] = TH1F( "ljet1_eta", ";Leading large-R jet #eta;Events / Bin Width", 40, -2.0, 2.0 )
_h['ljet1_phi'] = TH1F( "ljet1_phi", ";Leading large-R jet #phi;Events / Bin Width", 32, -3.1415, 3.1415 )
_h['ljet1_E']  = TH1F( "ljet1_E",  ";Leading large-R jet E [GeV];Events / Bin Width", 40, 0., 2000 )
_h['ljet1_m']  = TH1F( "ljet1_m",  ";Leading large-R jet m [GeV];Events / Bin Width", 40, 0., 200. )
...
_h['ljet2_px'] = TH1F( "ljet2_px", ";2nd leading large-R jet p_{x} [GeV];Events / Bin Width", 50, -500, 500 )
_h['ljet2_py'] = TH1F( "ljet2_py", ";2nd leading large-R jet p_{y} [GeV];Events / Bin Width", 50, -500, 500 )
_h['ljet2_pz'] = TH1F( "ljet2_pz", ";2nd leading large-R jet p_{z} [GeV];Events / Bin Width", 60, -1500, 1500 )
_h['ljet2_pt'] = TH1F( "ljet2_pt", ";2nd leading large-R jet p_{T} [GeV];Events / Bin Width", 40,   200., 600 )
_h['ljet2_eta'] = TH1F( "ljet2_eta", ";2nd leading large-R jet #eta;Events / Bin Width", 40, -2.0, 2.0 )
_h['ljet2_phi'] = TH1F( "ljet2_phi", ";2nd leading large-R jet #phi;Events / Bin Width", 32, -3.1415, 3.1415 )
_h['ljet2_E']  = TH1F( "ljet2_E",  ";2nd leading large-R jet E [GeV];Events / Bin Width", 40, 0., 2000 )
_h['ljet2_m']  = TH1F( "ljet2_m",  ";2nd leading large-R jet m [GeV];Events / Bin Width", 40, 0., 200. )
...
_h['jj_px'] = TH1F( "jj_px", ";Dijet system p_{x} [GeV];Events / Bin Width", 30, -300, 300 )
_h['jj_py'] = TH1F( "jj_py", ";Dijet system p_{y} [GeV];Events / Bin Width", 30, -300, 300 )
_h['jj_pz'] = TH1F( "jj_pz", ";Dijet system p_{z} [GeV];Events / Bin Width", 40, -2000, 2000 )
_h['jj_pt'] = TH1F( "jj_pt", ";Dijet system p_{T} [GeV];Events / Bin Width", 40,    0., 800 )
_h['jj_eta'] = TH1F( "jj_eta", ";Dijet system #eta;Events / Bin Width", 60, -6.0, 6.0 )
_h['jj_phi'] = TH1F( "jj_phi", ";Dijet system #phi;Events / Bin Width", 32, -3.1415, 3.1415 )
_h['jj_E']  = TH1F( "jj_E",  ";Dijet system E [GeV];Events / Bin Width", 40, 0., 4000 )
_h['jj_m']  = TH1F( "jj_m",  ";Dijet system m [GeV];Events / Bin Width", 80, 0., 4000. )
_h['jj_dPhi'] = TH1F( "jj_dPhi", ";Dijet system #Delta#phi;Events / Bin Width", 32, 0, 3.1415 )
_h['jj_dEta'] = TH1F( "jj_dEta", ";Dijet system #Delta#eta;Events / Bin Width", 30, -3., 3. )
_h['jj_dR']   = TH1F( "jj_dR",   ";Dijet system #Delta R;Events / Bin Width",   60, 2., 5 )

_h['ljet1_E_vs_pt']  = TH2F( "ljet1_E_vs_pt",  ";Leading large-R jet p_{T} [GeV];Leading large-R jet E [GeV]", 40, 200., 800., 50, 0., 2000 )
_h['ljet1_m_vs_pt']  = TH2F( "ljet1_m_vs_pt",  ";Leading large-R jet p_{T} [GeV];Leading large-R jet m [GeV]", 40, 200., 800., 40, 0., 200. )
_h['ljet1_m_vs_eta'] = TH2F( "ljet1_m_vs_eta", ";Leading large-R jet #eta;Leading large-R jet m [GeV]", 40, -2.0, 2.0, 30, 0., 600. )

_h['ljet2_E_vs_pt']  = TH2F( "ljet2_E_vs_pt",  ";2nd leading large-R jet p_{T} [GeV];2nd leading large-R jet E [GeV]", 40, 200., 800, 50, 0, 2000 )
_h['ljet2_m_vs_pt']  = TH2F( "ljet2_m_vs_pt",  ";2nd leading large-R jet p_{T} [GeV];2nd leading large-R jet m [GeV]", 40, 200., 800, 40, 0., 200. )
_h['ljet2_m_vs_eta'] = TH2F( "ljet2_m_vs_eta", ";2nd leading large-R jet #eta;2nd leading large-R jet m [GeV]", 40, -2.0, 2.0, 40, 0., 200. )

_h['ljet2_pt_vs_ljet1_pt'] = TH2F( "ljet1_pt_vs_ljet2_pt", ";Leading large-R jet p_{T} [GeV];2nd leading large-R jet p_{T} [GeV]", 40, 200, 800, 40, 200, 800.  )
_h['ljet2_m_vs_ljet1_m']   = TH2F( "ljet2_m_vs_ljet1_m",   ";Leading large-R jet m [GeV];2nd leading large-R jet m [GeV]", 40, 0., 200., 40, 0., 200. )
_h['ljet2_eta_vs_ljet1_eta'] = TH2F( "ljet2_eta_vs_ljet1_eta", ";Leading large-R jet #eta;2nd leading large-R jet #eta", 20, 0, 2.0, 20, 0, 2.0 )
